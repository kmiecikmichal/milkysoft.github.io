...
export default function Home() {
  ...
  return (
    <main className="min-h-screen" style={{ backgroundColor: 'var(--color-grey)' }}>
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden py-12" style={{ backgroundColor: 'var(--color-grey)' }}>
        <div className="absolute inset-0"></div>
        <div className="max-w-7xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10 w-full">
          <h1 className="text-5xl xs:text-6xl sm:text-7xl md:text-8xl lg:text-9xl tracking-tight mb-4 sm:mb-6" style={{ color: 'var(--color-white)', letterSpacing: 'letter-spacing-md' }}>
            MILKYSOFT
          </h1>
          <p className="text-base xs:text-lg sm:text-xl md:text-2xl mb-8 sm:mb-12 max-w-3xl mx-auto leading-relaxed" style={{ color: 'var(--color-white)' }}>
      ...
      {/* Features Section */}
      <section id="about" className="py-32 relative" style={{ backgroundColor: 'var(--color-grey)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-4xl mb-4" style={{ 
              color: 'var(--color-white)', 
              borderBottom: '4px solid var(--color-orange)', 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            onMouseOut={e => { 
              ...
              <h3 className="text-2xl mb-3" style={{ color: 'var(--color-orange)' }}>MODERN TECHNOLOGY</h3>
              <p>
            ...
            onMouseOut={e => { 
              ...
              <h3 className="text-2xl mb-3" style={{ color: 'var(--color-orange)' }}>SCALABLE SOLUTIONS</h3>
              <p>
            ...
            onMouseOut={e => { 
              ...
              <h3 className="text-2xl mb-3" style={{ color: 'var(--color-orange)' }}>EXPERT SUPPORT</h3>
              <p>
      ...
      {/* Contact Section */}
      <section id="contact" className="py-32 relative" style={{ backgroundColor: 'var(--color-grey)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-4xl mb-4" style={{ 
              color: 'var(--color-white)', 
            ...
            <p className="text-base max-w-2xl mx-auto" style={{ color: 'var(--color-white)' }}>
          ...
          <div className="max-w-xl mx-auto">
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div>
                <label htmlFor="email" className="block text-base mb-2" style={{ color: 'var(--color-white)' }}>
                  EMAIL
                </label>
                <input
                  type="email"
              ...
              <div>
                <label htmlFor="message" className="block text-base mb-2" style={{ color: 'var(--color-white)' }}>
                  MESSAGE
                </label>
                <textarea
                  id="message"
